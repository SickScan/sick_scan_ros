/**
 * \file
 * \brief Declaration CoLaA Serializer
 *
...
/**
 * @class CoLaASerializer
 * @brief CoLaA Serializer
 *
 */
class CoLaASerializer : public Serializer {
 public:
  /**
   * @brief Construct a new CoLaASerializer object
   *
   */
  CoLaASerializer(void){};
  /**
   * @brief Destroy the CoLaASerializer object
   *
   */
  ~CoLaASerializer(void){};
 ...
 protected:
  CoLaASerializer(const CoLaASerializer&);
  CoLaASerializer& operator=(const CoLaASerializer&);
  /**
